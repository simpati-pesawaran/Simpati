    ...
    <>
      ...
      >
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-0 right-0 w-32 h-32 bg-white/10 rounded-full blur-2xl" style={{ transform: "translate(20%, -30%)" }} />
          <div className="absolute bottom-0 left-0 w-48 h-48 bg-purple-500/20 rounded-full blur-2xl" style={{ transform: "translate(-30%, 50%)" }} />
        </div>
